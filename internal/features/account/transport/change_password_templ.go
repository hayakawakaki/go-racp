...
func changePasswordForm(state ChangePasswordState) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if state.Errors["current_password"] != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/features/account/transport/change_password.templ`, Line: 27, Col: 75}
			}
		...
		if state.Errors["new_password"] != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/features/account/transport/change_password.templ`, Line: 34, Col: 71}
			}
		...
		if state.Errors["new_password_confirm"] != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/features/account/transport/change_password.templ`, Line: 41, Col: 79}
			}
