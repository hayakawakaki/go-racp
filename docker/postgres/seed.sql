DELETE FROM cp_settlement WHERE listing_id IN (SELECT id FROM cp_listing WHERE seller_account_id IN (2000005, 2000006, 2000007, 2000008, 2000010, 2000026));
DELETE FROM cp_listing WHERE seller_account_id IN (2000005, 2000006, 2000007, 2000008, 2000010, 2000026);
DELETE FROM cp_currency_hold WHERE account_id IN (2000005, 2000006, 2000007, 2000008, 2000010, 2000026);
